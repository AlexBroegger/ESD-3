-- NOTES:
        -- Ny port: DEBUG_DATA_IN, eneste ændring er at når vi bruger read nu læser den det, som bare er top-modul byte.
...
entity UART_parser is
    Port (
        ...
        -- NEW PORT: This is the "window" to see the sensor data
